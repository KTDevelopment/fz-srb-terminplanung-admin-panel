...
import {ParticipationStateEdit} from "./ParticipationStateCreateAndEdit/ParticipationStateEdit";
import {ParticipationStateCreate} from "./ParticipationStateCreateAndEdit/ParticipationStateCreate";

export const ParticipationStateResource = () => <Resource
    name="participation-states"
    icon={LabelIcon}
