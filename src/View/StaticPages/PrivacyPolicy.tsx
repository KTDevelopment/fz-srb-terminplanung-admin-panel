        ...
        return (
            <React.Fragment>
                <div className="Static-Content">
                    ...
                    <p> Kevin Thürmann built the Fanfarenzug Strausberg app as a Free app. This
                        SERVICE is provided by Kevin Thürmann at no cost and is intended for use as is.
                    </p>
                    ...
                    <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions,
                        which
                        is accessible
                        at Fanfarenzug Strausberg unless otherwise defined in this Privacy Policy.
                    </p>
                    <p><strong>Information Collection and Use</strong></p>
                    <p>For a better experience, while using our
                    ...
                    <div><p>Link to privacy policy of third party service providers used by the app</p>
                        <ul>
                            ...
                            <li><a href="https://firebase.google.com/policies/analytics" target="_blank"
                                   rel="noopener noreferrer">Firebase Analytics</a></li>
                        </ul>
                    </div>
                    ...
                    <p><strong>Cookies</strong></p> <p>Cookies are files with a small amount of data that are commonly
                    used
                    as anonymous unique identifiers. These
                    ...
                    <p> I may employ third-party companies and individuals due to
                    ...
                    <p>This Service may contain links to other sites. If you
                        click on a third-party link, you will be directed
                    ...
                    <p>These Services do not address anyone under the age of
                        13.
                        I do not knowingly collect
                    ...
                    <p> I may update our Privacy Policy from time to
                        time. Thus, you are advised to review
                    ...
                    <p>If you have any questions or suggestions about my Privacy Policy,
                        do not hesitate to contact me. <a href='#/contact'>Contact</a>
                    </p>
                </div>
            </React.Fragment>
        );
