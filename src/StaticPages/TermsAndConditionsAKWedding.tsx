export const TermsAndConditionsAKWedding = () => (
  <div style={{ padding: 20 }}>
    ...
    <p>
      ...
      intellectual property rights related to it, still belong to Kevin
      Thürmann.
    </p>
    <p>
      Kevin Thürmann is committed to ensuring that the app is as useful and
      efficient as possible. For that reason, we reserve the right to make
      changes to the app or to charge for its services, at any time and for any
      reason. We will never charge you for the app or its services.
    </p>
    <p>
      The A ♥ K app stores and processes personal data that you have provided to
      us, in order to provide the service. It’s your responsibility to keep your
      ...
      features and it could mean that the A ♥ K app won’t work properly or at
      all.{" "}
    </p>
    <p>
      You should be aware that there are certain things that Kevin Thürmann will
      ...
      provided by your mobile network provider, but Kevin Thürmann cannot take
    ...
    <p>
      Along the same lines, Kevin Thürmann cannot always take responsibility for
      ...
      Service, Kevin Thürmann cannot accept responsibility
    </p>
    <p>
      With respect to Kevin Thürmann’s responsibility for your use of the app,
      ...
      available to you. Kevin Thürmann accepts no liability for any loss, direct
      or indirect, you experience as a result of relying wholly on this
      functionality of the app.
    </p>
    <p>
      At some point, we may wish to update the app. The app is currently
      available on Android and iOS – the requirements for both systems (and for
      ...
      using the app. Kevin Thürmann does not promise that it will always update
      the app so that it is relevant to you and/or works with the iOS/Android
    ...
    <p>
      ...
      not hesitate to contact me. <a href="#/contact">Contact</a>
    </p>
  </div>
);
